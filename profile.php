                    ...
                    <div class="user-profile layout-spacing">
                        <div class="widget-content widget-content-area">
                            <div class="d-flex justify-content-between">
                                <h3 class="">Profile <?= $_SESSION['id'] ?></h3>
                                    ...
                                    <ul class="contacts-block list-unstyled">
                                        ...
                                        <li class="contacts-block__item">
                                            ...
                                            <form method="post" action="pro.php">
                                                status: <br><input type="radio" name="grade" value="infected">
                                                infected<br><input type="radio" name="grade" value="immuned">immuned<br>
                                                Since: <input class="form-control" type="date" name="date">
