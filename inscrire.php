...
<head>
    ...
    if (isset($_POST["email"])) {
        ...
        try {
            $sql = "INSERT INTO `user`( `email`, `mdp`, `name`, `telephone`, `adresse`, `grade`) VALUES ('" . $email . "','" . $mdp . "', '" . $name . "', '" . $telephone . "', '" . $adresse . "','vendeur')";
                            ...
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary" value="">Subscribe</button>
                                    </div>
                                </div>
